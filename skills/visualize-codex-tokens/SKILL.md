...
description: Generate a self-contained interactive HTML report with a token-progress dual-ring view of Codex consumption and context-window occupancy, plus exact per-tool-call usage satellites, for one local thread, one local date, or an inclusive local date range.
---
